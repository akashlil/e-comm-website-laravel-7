  ...
  <!-- single-product-area start-->
           ...
           <div class="row">
               <div class="col-lg-6">
                   <div class="product-single-img">
                       <div class="product-active owl-carousel">
                           <div class="item">
                               <img src="{{asset('upload/product_photo')}}/{{ $product_single_info->product_thumbnail_photo  }}" alt="">
                           </div>
                           @foreach ($multiple_photos as $multiple_photo)

                             <div class="item">
                               <img src="{{asset('upload/product_multiple_photos')}}/{{ $multiple_photo->photo_name  }}" alt="">
                             </div>
                           @endforeach
               ...
               <div class="col-lg-6">
                   <div class="product-single-content">
                     ...
                     @endif
                       <h3> {{$product_single_info->product_name}}</h3>
                       <div class="rating-wrap fix">
                           <span class="pull-left">${{$product_single_info->product_price}}</span>
                       ...
                       <p>{{$product_single_info->product_short_description }}</p>
                       <p> Available Quantity :  {{$product_single_info->product_quantity}}</p>
                       <ul class="input-style">
                         @if ($product_single_info->product_quantity==0)
                           <div class="alert alert-danger">
                           ...
                           @else
                             <form action="{{ url('add/to/cart') }}" method="post">
                                           @csrf
                              <input  type="hidden" value="{{ $product_single_info->id }}" name="product_id" />
                               <li class="quantity cart-plus-minus">
                                   <input  type="text" value="1"  name="quantity"/>
                               </li>

                                 <li>
                                   <button class="form-control btn btn-danger" type="submit"  >Add to Cart</button>
                                 </li>
                               </form>
                         @endif
                       ...
                       <ul class="cetagory">
                           <li>Categories:</li>
                           {{-- 1 line same working --}}
                           <li><a href="#">{{ $product_single_info->relationaltocategorytable->category_name }}</a></li>
                           {{-- <li><a href="#">{{ App\Category::find($product_single_info->category_id)->category_name }}</a></li> --}}
                       </ul>
                       <ul class="socil-icon">
                           <li>Share :</li>
                   ...
                   <div class="tab-content">
                       <div class="tab-pane active" id="description">
                           <div class="description-wrap">
                               <p>{{$product_single_info->product_long_description }} </p>
                           </div>
                       </div>
   ...
   <div class="featured-product-area">
       <div class="container">
           ...
           <div class="row">
             @forelse ($related_product_info as $product_info)
               <div class="col-lg-3 col-sm-6 col-12">
                   <div class="featured-product-wrap">
                       <div class="featured-product-img">
                           <img src="{{asset('upload/product_photo')}}/{{ $product_info->product_thumbnail_photo  }}" alt="">
                       </div>
                       <div class="featured-product-content">
                           <div class="row">
                               <div class="col-7">
                                   <h3><a href="{{ url('product/details') }}/{{ $product_info->id }}">{{$product_info->product_name}}</a></h3>
                                   <p>${{$product_info->product_price}}</p>
                               </div>
                               <div class="col-5 text-right">
                                   <ul>
                                       <li><a href="{{ url('product/details') }}/{{ $product_info->id }}"><i class="fa fa-shopping-cart"></i></a></li>
