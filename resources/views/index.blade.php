                          ...
                          <div class="col-lg-12 col-lg-9 col-12">
                            <div class="slider-content">
                              <div class="slider-shape">
                                ...
                                <p data-swiper-parallax="-400">{{ $slider->slider_paragraph }}</p>
           ...
           <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                  <div class="product-wrap">
                    <div class="product-img">
                      <img src="{{asset('upload/product_photo/')}}/{{App\Product::find($best_seller->product_id)->product_thumbnail_photo  }}" alt="">
                      <div class="product-icon flex-style">
                        <ul>
                          <li><a data-toggle="modal" data-target="#product_id{{App\Product::find($best_seller->product_id)->id }}" href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                    ...
                    <div class="product-content">
                      <h3><a href="{{url('product/details')}}/{{ App\Product::find($best_seller->product_id)->id }}">{{App\Product::find($best_seller->product_id)->product_name}}</a></h3>
                      <p class="pull-left">${{App\Product::find($best_seller->product_id)->product_price}}
                      </p>
